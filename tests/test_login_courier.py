...
class TestLoginCourier:
    @staticmethod
    def _login_courier(*, request_body: dict) -> requests.Response:
    ...
    def test_courier_log_in(self):
        response = self._login_courier(request_body=Users.data_current)
    ...
    def test_courier_log_negative(self):
        response = self._login_courier(request_body=Users.data_negative)
    ...
    def test_courier_log_not_all_data(self, data_without_login_or_password):
        response = self._login_courier(request_body=data_without_login_or_password)
